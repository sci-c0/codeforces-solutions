...
Long before the start the friends decided that they will implement a problem if at least two of them are sure about 
...
know how to solve the second problem. That means that they will write solutions for these problems.
...
def will_solve(probs: str) -> bool:
    """

    :param probs: str: A string of 3 '0's or '1's corresponding to solvable or not
    :return: bool: True/False indicating whether all 3 friends can solve this problem
    """
    return probs.count('1') > 1


if __name__ == '__main__':
    tests = int(input())
    print(sum((will_solve(input()) for _ in range(tests))))
